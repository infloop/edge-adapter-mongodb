...
var Errors = require('./edge-adapter-abstract/errors.js');
...
module.exports = (function () {
    ...
    var identity = 'edge-mongo';

    /**
     * @implements {IAdapterInterface}
     */
    var adapter = {
        ...
        teardown: function (connectionName, cb) {
            ...
            var dbConnection = connections[connectionName].connection.db;
